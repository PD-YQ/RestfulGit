...
import { CommitMySuffixComponent } from 'app/entities/commit-my-suffix/commit-my-suffix.component';
...
describe('Component Tests', () => {
  describe('CommitMySuffix Management Component', () => {
    let comp: CommitMySuffixComponent;
    let fixture: ComponentFixture<CommitMySuffixComponent>;
    let service: CommitMySuffixService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [RestfulGitTestModule],
        declarations: [CommitMySuffixComponent],
        providers: [
          {
        ...
        .overrideTemplate(CommitMySuffixComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(CommitMySuffixComponent);
